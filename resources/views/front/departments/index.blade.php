                        ...
                        <div class="product-grid-topbar">
                            <div class="row align-items-center">
                                <div class="col-lg-7 col-md-8 col-12">
                                    ...
                                    {{$departments->withQueryString()->links('pagination::tailwind');}}
                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12" style="height: 35em;">
                                            ...
                                            <div class="single-product">
                                                <div class="product-image">
                                                    <img height="250em" src="{{ asset('storage/'.$department->image) }}" alt="#">

                                                </div>
                                                <div class="product-info">
                                                    <h4 class="title">
                                                        <a
                                                            href="{{ route('front.department.show', $department->id) }}">{{ $department->name }}</a>
                                                    </h4>
                                                    <ul class="review">
                                            ...
                                            <div class="single-product">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-4 col-md-4 col-12">
                                                        <div class="product-image">
                                                            <img style="height: 6rem; width:10rem;"
