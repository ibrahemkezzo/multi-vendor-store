                    ...
                    <div class="total-amount">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        <li>Cart Subtotal<span>{{App\Helpers\Currency::formate($cart->total(),'USD')}}</span></li>
                                        <li>Shipping<span>Free</span></li>
                                        <li>You Save<span>$29.00</span></li>
                                        <li class="last">You Pay<span>{{App\Helpers\Currency::formate($cart->total(),'USD')}}</span></li>
                                    </ul>
                                    <div class="button">
